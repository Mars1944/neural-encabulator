...
- paths.outputs_root: Base folder for generated artifacts (heatmaps, stitched images, confusion matrices, checkpoints). Used by common.PathResolver in infer.py, trainer.py, viewer.
